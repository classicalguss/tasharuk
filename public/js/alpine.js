...
/* harmony export */   "schoolLogo": function() { return /* binding */ schoolLogo; }
/* harmony export */ });
...
var colors = ['success', 'danger', 'secondary', 'warning', 'info', 'dark', 'primary'];
function avatar(user) {
  var $output = '<a href="/users/' + user.id + '">';
  if (user['profile_photo_url']) {
    $output += '<img src="' + user['profile_photo_url'] + '" alt="" class="rounded-circle">';
  } else {
    var colorClass = colors[user['id'] % 7],
